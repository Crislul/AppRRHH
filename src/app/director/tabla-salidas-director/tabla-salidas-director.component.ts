...
import { Salida } from '../../admin/tabla-salidas-admin/tabla-salidas-admin.component';
...
@Component({
  selector: 'app-tabla-salidas-director',
  imports: [
    CommonModule,
    MatTableModule,
    MatFormFieldModule, 
  ...
  templateUrl: './tabla-salidas-director.component.html',
  styleUrl: './tabla-salidas-director.component.css'
})
export class TablaSalidasDirectorComponent implements OnInit, AfterViewInit{
      ...
      getAutorizaciones(): void {
        ...
        this.salidaService.getAutorizaciones().subscribe(
          (data) => {
            ...
            const filteredData = data.filter((salida) => {
              return salida.areaId === userId;
            });
