...
@Component({
  selector: 'app-salida-director',
  imports: [CommonModule],
  templateUrl: './salida-director.component.html',
  styleUrl: './salida-director.component.css'
})
export class SalidaDirectorComponent implements OnInit{
 ...
 constructor(
  ...
  actualizarEstatus(estatusDir: number): void {
    ...
    this.salidaService.updateAutorizacion(this.salida.id, salidaActualizada).subscribe(
      () => {
        this.salida!.estatusDir = estatusDir;
